...
def get_video_duration(video):
    ...
    duration = parse_ffprobe_output(result)
    if duration is None:
        return "00:00:00"
    video_duration_str = format_duration(duration)
    save_video_duration(video, video_duration_str)    
...
def parse_ffprobe_output(result):
...
def save_video_duration(video, video_duration_str):
